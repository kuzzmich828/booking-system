<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
<head style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
    <meta name="viewport" content="width=device-width" style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
    <style style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
        * {
            margin: 0;
            padding: 0;
            font-size: 100%;
...
<body style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;height: 100%;background: #FFF;-webkit-font-smoothing: antialiased;-webkit-text-size-adjust: none;width: 100% !important;">
<table class="body-wrap" style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;height: 100%;background: #FFF;-webkit-font-smoothing: antialiased;-webkit-text-size-adjust: none;width: 100% !important;">
                        ...
                        <table class="room-info" style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black; border-collapse: collapse;width: 100% !important;">
                            <tr style="font-size: 14px;margin: 0;padding: 0;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
                                <td style="min-width: 110px; height: 20px;background-color: #eee35e;border: unset;word-break: break-all;font-size: 12px;width: 33%;padding: 5px 9px 3px 9px;;margin: 0;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
                                    <span style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: #FFFFFF;padding-left: 3px;">שם</span> <b style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.2em;color: black; "><?= $booking['name']; ?></b></td>
                    ...
                    <td align="center" class="mastfooter" style="padding: 35px 0 0 0;background: #000000;border-top: unset;color: white;margin: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;">
                        <table style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;height: 100%;border-collapse: collapse;width: 100% !important;">
                            ...
                            <tr style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;">
                                ...
                                <td style="margin: 0;padding: 0;font-size: 100%;font-family: 'Arial', 'sans-serif';line-height: 1.4;color: black;"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
